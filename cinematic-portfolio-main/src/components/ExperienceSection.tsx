...
const journey: RouteStop[] = [
  {
    ...
    organization: 'WEBMYTECH',
    description: 'Developed, customized and maintained 100+ WordPress websites for business and corporate clients, including WooCommerce stores, theme customization, plugin configuration and performance optimization.',
  },
  {
    id: '02',
    year: 'CERTIFICATION',
    ...
    description: 'Certified in WordPress web development, covering theme customization, plugin configuration and responsive site building.',
  },
  {
    id: '03',
    year: 'CERTIFICATION',
    ...
    organization: 'NPTEL',
    description: 'Completed an NPTEL certification in Cloud Computing, building a foundation in scalable, distributed systems concepts.',
  },
  {
    id: '04',
    year: '2021 - 2023',
    ...
    description: 'Completed a Master of Computer Applications, building strong programming, database and web development fundamentals.',
  },
  {
    id: '05',
    year: '2018 - 2021',
    title: 'BACHELOR OF SCIENCE (B.SC.)',
    organization: 'KAMLA RAJA GIRLS AUTONOMOUS COLLEGE, GWALIOR',
    description: 'Completed a Bachelor of Science degree, laying the academic foundation before moving into computer applications and web development.',
  },
];
