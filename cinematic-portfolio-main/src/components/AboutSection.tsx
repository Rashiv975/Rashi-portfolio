...
import aboutImg from '../assets/Rashi.png';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <motion.p
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              I'm <span className="text-[#F3DBB3] font-medium">Rashi Verma</span>, a WordPress Web Developer with 2 years of hands-on experience designing, developing, customizing and maintaining responsive WordPress websites. Skilled in WooCommerce, Elementor, HTML5, CSS3, JavaScript, PHP and MySQL, I focus on clean theme customization, plugin configuration, and delivering projects on time, every time.
            </motion.p>
