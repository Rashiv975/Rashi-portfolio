  ...
  return (
    <section className="relative w-screen h-screen overflow-hidden bg-black text-[#E8DFD8] font-sans selection:bg-[#cbb59d] selection:text-black cursor-none">
      ...
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none bg-black flex items-center justify-end">
        ...
        >
          <source src="/videos/Rashi_video2.mp4" type="video/mp4" />
        </video>
        ...
        <div className="relative flex flex-col md:flex-row items-center justify-between w-full pt-4 pb-2 my-auto">
          ...
          >
            ...
            <motion.div variants={fadeUpVariants} className="mb-4">
              <p
                ...
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                WORDPRESS DEVELOPER <span className="text-[#8C6D4F] mx-1">•</span> WOOCOMMERCE <span className="text-[#8C6D4F] mx-1">•</span> ELEMENTOR
              </p>
            </motion.div>
            ...
            >
              <p>
                I design, build and maintain responsive WordPress websites for business and corporate clients.
                <br />
                From theme customization to WooCommerce stores, I turn client requirements into polished, fast, working sites.
              </p>
            </motion.div>
          ...
          >
            ...
            <div 
              ...
              style={{ fontFamily: "'Montserrat', sans-serif" }}
            >
              <p>WORDPRESS IS MY CRAFT.</p>
              <p>CLIENT SUCCESS IS MY GOAL.</p>
            </div>
