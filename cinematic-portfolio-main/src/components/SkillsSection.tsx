...
const bentoCategories = [
  {
    title: 'WORDPRESS & CMS',
    badge: 'CORE PILLAR',
    items: ['WordPress', 'WooCommerce', 'Elementor', 'Theme Customization', 'Plugin Configuration'],
    description: 'Building, customizing and maintaining responsive WordPress websites and WooCommerce stores end to end, from theme setup to plugin configuration.',
    stat: '100+ SITES',
  ...
  },
  {
    ...
    description: 'Designing and implementing responsive, cross-browser layouts that look and work great across desktop, tablet, and mobile.',
    stat: 'CROSS-DEVICE',
  ...
  },
  {
    ...
    badge: 'SERVER-SIDE',
    items: ['PHP', 'MySQL'],
    description: 'Working with PHP and MySQL to support dynamic WordPress functionality, custom queries, and site logic.',
    stat: 'DYNAMIC SITES',
    colSpan: 'lg:col-span-5',
  },
  {
    ...
    badge: 'OPTIMIZATION',
    items: ['Page Speed Optimization', 'Basic SEO', 'Git', 'GitHub', 'Figma', 'Canva'],
    description: 'Optimizing loading speed and responsiveness, implementing basic SEO best practices, and using Git and design tools to deliver polished, production-ready sites.',
    stat: 'FASTER LOAD TIMES',
    colSpan: 'lg:col-span-7',
  },
];
