...
const projects: Project[] = [
  {
    number: '01',
    title: 'Career Gurujee',
    category: 'EDUCATION / E-COMMERCE',
    description:
      'A responsive WordPress e-commerce website built for an education and career counselling platform. Implemented course listings, career counselling flows, and admission-related content sections tailored to project requirements.',
    liveUrl: 'https://careergurujee.com/',
    tech: ['WordPress', 'WooCommerce', 'Elementor', 'HTML5', 'CSS3', 'JavaScript'],
    metrics: [
      { label: 'TYPE', value: 'E-Commerce Site' },
      { label: 'FOCUS', value: 'Courses & Admissions' },
      { label: 'BUILD', value: 'Elementor + WooCommerce' },
    ],
  },
  {
    number: '02',
    ...
    description:
      'Developed and customized a responsive WordPress e-commerce website with full product listings, e-commerce sections, and business content built to project specifications for a retail brand.',
    liveUrl: 'https://roopbyra.com/',
    tech: ['WordPress', 'WooCommerce', 'Elementor', 'Responsive Design'],
    metrics: [
      { label: 'TYPE', value: 'E-Commerce Store' },
      { label: 'FOCUS', value: 'Product Catalog' },
      { label: 'BUILD', value: 'WooCommerce' },
    ],
  },
  {
    number: '03',
    title: 'Waltz & Seij DPDP',
    category: 'BUSINESS / CORPORATE SITE',
    description:
      'Developed and customized a responsive WordPress website with polished layouts and business content, delivered to client requirements and deadlines for a corporate services brand.',
    liveUrl: 'https://waltzdpdp.com/',
    tech: ['WordPress', 'Elementor', 'HTML5', 'CSS3'],
    metrics: [
      { label: 'TYPE', value: 'Corporate Website' },
      { label: 'FOCUS', value: 'Business Content' },
      { label: 'BUILD', value: 'Elementor' },
    ],
  },
  {
    number: '04',
    title: 'Adi Devajya Enterprise',
    category: 'MEDICAL IMPORT-EXPORT',
    description:
      'Developed and customized WordPress website pages covering business, medical import-export, and industry-related content sections based on detailed project requirements.',
    liveUrl: 'https://adidevajyaenterprise.com/',
    tech: ['WordPress', 'Elementor', 'HTML5', 'CSS3', 'JavaScript'],
    metrics: [
      { label: 'TYPE', value: 'Business Website' },
      { label: 'FOCUS', value: 'Import-Export Content' },
      { label: 'BUILD', value: 'Custom Pages' },
    ],
  },
  {
    number: '05',
    ...
    description:
      'Built and customized a responsive WordPress website for a travel and tourism business, implementing clean layouts and business-focused content sections.',
    liveUrl: 'https://exploratour.in/',
    tech: ['WordPress', 'Elementor', 'Responsive Design'],
    metrics: [
      { label: 'TYPE', value: 'Travel Website' },
      { label: 'FOCUS', value: 'Tour Content' },
      { label: 'BUILD', value: 'Elementor' },
    ],
  },
  {
    number: '06',
    title: 'Modern Crop Science / Wilshire Agro',
    category: 'AGRI-BUSINESS',
    description:
      'Developed and customized responsive WordPress websites for agriculture and agri-input businesses, implementing responsive layouts and industry-specific business content.',
    liveUrl: 'https://moderncropscience.com/',
    tech: ['WordPress', 'Elementor', 'HTML5', 'CSS3'],
    metrics: [
      { label: 'TYPE', value: 'Business Websites' },
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        >
          ...
          <p
            ...
            style={{ fontFamily: "'Montserrat', sans-serif" }}
          >
            Scroll down to explore the cards. Each site was designed, built, and customized to a client's requirements.
          </p>
        </motion.div>
