      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between">
            <div>
              ...
              <p
                ...
                style={{ fontFamily: "'Montserrat', sans-serif" }}
              >
                Have a WordPress project, a WooCommerce store to build, or a website that needs a refresh? Send a message below.
              </p>

              <div className="space-y-3" style={{ fontFamily: "'Montserrat', sans-serif" }}>
                <a
                  href="mailto:rashiv975@gmail.com"
                  className="flex items-center gap-3 text-xs text-[#BFA895] hover:text-[#F7E7C4] transition-colors"
                >
                  <span className="text-[#D4AF37]">✉</span> rashiv975@gmail.com
                </a>
                <a
                  href="tel:+916266813880"
                  className="flex items-center gap-3 text-xs text-[#BFA895] hover:text-[#F7E7C4] transition-colors"
                >
                  <span className="text-[#D4AF37]">☎</span> +91 6266813880
                </a>
                <div className="flex items-center gap-3 text-xs text-[#BFA895]">
                  <span className="text-[#D4AF37]">📍</span> Gwalior, M.P, India
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="pt-16 mt-16 border-t border-[#8C6D4F]/15 flex flex-col sm:flex-row items-center justify-between text-center sm:text-left gap-4">
          <span className="text-[10px] font-mono tracking-widest text-[#8C6D4F] uppercase">
            RASHI VERMA // WORDPRESS WEB DEVELOPER
          </span>
          <span className="text-[10px] font-mono text-[#8C6D4F]">
            © {new Date().getFullYear()} • BUILT WITH WORDPRESS & CARE
          </span>
        </div>
